...
#url = 'https://www.rightmove.co.uk/property-for-sale/find.html?keywords=&sortType=2&viewType=LIST&channel=BUY&index=0&radius=0.0&locationIdentifier=USERDEFINEDAREA%5E%7B%22polylines%22%3A%22enfxHmka%40mTfxrC%7DapAl%7DAoi%40efdDzarAnnM%22%7D'
...
if url != "": 
    ...
    searchLocation = driver.find_element_by_name('searchLocation')
    searchLocation.send_keys = postalCode

    buyButton = driver.find_element_by_id('buy')
    buyButton.click()
